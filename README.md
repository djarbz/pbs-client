...
When possible, all configuration should be performed via the supported Proxmox Environment Variables as defined [in the official docs](https://pbs.proxmox.com/docs/backup-client.html#environment-variables).
...
| PBS_NAMESPACE                 | Datastore Namespace for the backup                                                                     |                       |
